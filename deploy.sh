...
if [ "$FORCE_FULL" = true ]; then
  FULL_UPLOAD=true
  echo "Full upload forced via --force-full flag."
fi
...
if [ "$FULL_UPLOAD" = true ]; then
  # All files in current manifest are added/modified; nothing deleted.
  ...
  # Diff previous and current manifests using jq.
